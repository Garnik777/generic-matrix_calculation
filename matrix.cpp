...
template <typename T>
void readMatrix(Readfile& r,Matrix<T>& m) {
...
template <typename T>
void WriteMatrix(const Matrix<T>& y,Writefile& wy)
{
	using MI = interface<Matrix<T>>;
	typename MI::element_type x = 0;
